...
function validarEdad(valor) {
    ...
    if (valor > 100) {
        return 'El campo Edad no debe ser mayor a 100';
    }
...
function agregarMiembro(i) {
    ...
    input.setAttribute('class','form-control my-1 border-sucess');

    const mensajeError = document.createElement('span');
    mensajeError.setAttribute('class','mensajeError text-danger');
    
    const div = document.createElement('div');
    div.setAttribute('class','miembros my-2');
